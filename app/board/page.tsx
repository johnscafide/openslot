          ...
          <div style={{ marginBottom: 20, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div
              ...
              style={{
                ...
                background: showSavedOnly ? '#10b981' : '#e5e7eb',
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ flex: 1, padding: '16px 18px', display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                      ...
                      <div style={{
                        ...
                        {slot.business_category === 'Salon & barber' ? '✂️'
                          ...
                          : slot.business_category === 'Golf' ? '⛳'
                          : slot.business_category === 'Spa' ? '💆'
                          : slot.business_category === 'Dining' ? '🍽️'
                          : slot.business_category === 'Services' ? '📋' : '📌'}
                      </div>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: 3 }}>
                          ...
                          {isUrgent && (
                            <span style={{ fontSize: 10, fontWeight: 700, background: '#fee2e2', color: '#dc2626', padding: '2px 7px', borderRadius: 20, flexShrink: 0, marginTop: 1 }}>
                              HOT
                            </span>
                          )}
                          {isShared && (
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: 6 }}>
                          ...
                          <span style={{ fontSize: 11, color: '#9ca3af' }}>({rating.count} reviews)</span>
                        </div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 10, flexShrink: 0 }}>
                        ...
                        <div style={{ textAlign: 'right' }}>
                          ...
                          <div style={{ fontSize: 11, color: '#10b981', fontWeight: 600 }}>
                            save ${(slot.original_price - slot.deal_price).toFixed(0)}
                          </div>
                        </div>
          ...
          {needForm && !needSubmitted && (
            <div style={{ marginTop: 24, background: 'white', borderRadius: 12, border: '1px solid #e5e7eb', padding: 24 }}>
              ...
              <p style={{ fontSize: 13, color: '#6b7280', marginBottom: 16 }}>Matching businesses in your area will be notified.</p>
              <form onSubmit={handleNeedSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  ...
                  <button type="button" onClick={() => setNeedForm(false)} style={{ padding: '9px 20px', background: 'white', border: '1px solid #e5e7eb', borderRadius: 8, fontSize: 13, color: '#6b7280', cursor: 'pointer' }}>
                    Cancel
                  </button>
                </div>
              </form>
